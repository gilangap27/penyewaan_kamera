                ...
                <form action="./sewa.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="tanggal_sewa" id="produk" value="" required>
                        </div>
                        <div class="mb-3">
                            <label for="produk" class="col-form-label">Email Penyewa</label>
                            <input type="email" class="form-control" name="email" id="produk" value="" required>
                        </div>
                        <div class="mb-3">
                            <label for="produk" class="col-form-label">Nama Penyewa</label>
                            <input type="text" class="form-control" name="nama" id="produk" value="" required>
                        </div>
                        <div class="mb-3">
